...
typedef enum
{
    ble_dht_EVT_NOTIFICATION_ENABLED,                             /**< Battery value notification enabled event. */
    ble_dht_EVT_NOTIFICATION_DISABLED                             /**< Battery value notification disabled event. */
} ble_dht_evt_type_t;

/**@brief Battery Service event. */
typedef struct
{
    ble_dht_evt_type_t evt_type;                                  /**< Type of event. */
} ble_dht_evt_t;
...
typedef void (*ble_dht_evt_handler_t) (ble_dht_t * p_dht, ble_dht_evt_t * p_evt);

/**@brief Battery Service init structure. This contains all options and data needed for
 *        initialization of the service.*/
typedef struct
{
    ble_dht_evt_handler_t         evt_handler;                    /**< Event handler to be called for handling events in the Battery Service. */
